 ...
 * @author gavalian
 */
public class FTProcessorPane extends JPanel implements ActionListener {
    ...
    private int                  dataPaneStyle = FTProcessorPane.TOOLBAR;
    ...
    public FTProcessorPane(){
        super();
        initUI();
    }
    
    public FTProcessorPane(String host, String ip){
        super();
        initUI();
    ...
    private void initUI(){
        ...
        ImageIcon playIcon  = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/default/play-20x20.png"));
        ImageIcon pauseIcon = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/pause_24px.png"));
        ImageIcon fileIcon  = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/default/etring-20x20.png"));
...
//        sourcePane.add(sourceFileRing);
    ...
    private JPanel  createMediaPane(){
        ...
        ImageIcon playIcon  = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/thin/play-24x24.png"));
        ImageIcon pauseIcon = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/thin/pause-24x24.png"));
        ImageIcon nextIcon  = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/thin/next-24x24.png"));
        ImageIcon prevIcon  = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/thin/previous-24x24.png"));
        ImageIcon ejectIcon  = new ImageIcon(FTProcessorPane.class.getClassLoader().getResource("icons/media/themes/thin/eject-24x24.png"));
    ...
    public static void main(String[] args){
        ...
        FTProcessorPane pane = new FTProcessorPane();
